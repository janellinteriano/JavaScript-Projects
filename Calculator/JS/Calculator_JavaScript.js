...
const Calculator = {
    ...
    //this wil hold the operator, we set it to null for now
    operator: null,
};
...
function Handle_Operator(Next_Operator) {
    ...
    //CalculatorFirst_Operand if it doesn't already exist
...
keys.addEventListener('click', (event) => {
    ...
    //ensures that AC clears all inputs from thr Calculator screen
